...
hurd <- c("geit", "geit", "bíll")
peningur <- 0

for(i in 1:100000){ #hermun 
  utkoma <- sample(hurd,1) #Slembival á einum hlut úr Hurd.
  if(utkoma=="bíll"){ #Ef bíll þá +5.000.000kr
    peningur <- peningur+5000000
    i+1 
  }
    if(utkoma== "geit"){
