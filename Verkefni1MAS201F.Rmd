...
-Látum P(A) vera atburðurinn að velja hurð 1.
-Látum P(B) vera atburðurinn að Monty Hall sýnir geit bakvið hurð 2.
$$
P(A|B) = \frac
  {P(B|A) P(A)} 
  {P(B)}
...
Þá getum við ályktað sem svo að líkurnar á því að velja hurð 1 hefur líkurnar 1/3 og að bakvið hana sé bíll en að velja hurð 3 hefur líkurnar 2/3.
